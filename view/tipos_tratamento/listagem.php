...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
  ...
  <legend class="page-header">Listagem de Tipos de Tratamento
    ...
    <table class="table table-striped table-condensed table-hover" id="listagem">
      ...
      <tbody>
        <?php foreach ($tipos as $row) { ?>
          <tr>
            <td><?php echo $row["TIPOTRATAMENTO_ID"]; ?></td>
            <td><?php echo $row["DESCRICAO"]; ?></td>
            <td>
              <div class="text-center">
                <div class="btn-group btn-group-xs">
                  <a class="btn btn-primary" title="Editar registro" href="cadastro.php?id=<?php echo $row["TIPOTRATAMENTO_ID"];?>"><span class="glyphicon glyphicon-edit"></span> Editar</a>
                  <a class="btn btn-danger" title="Excluir registro" onclick="javascript: if(confirm('Confirma a exclusão do registro?')) location.href='cadastro.php?acao=excluir&id=<?php echo $row["TIPOTRATAMENTO_ID"];?>'">
