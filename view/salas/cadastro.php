    ...
    <form id="form_cad" class="form" role="form" method="post">
      ...
      <div class="row">
        <div class="form-group col-lg-12">
          <span>Descrição:</span>
          <input type="text" name="descricao" class="form-control" maxlength="80" value="<?php echo $sala->getDescricao(); ?>" required autofocus
